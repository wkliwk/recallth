...
export default function MobileDrawer({ isOpen, onClose }) {
  ...
  return (
    <div className="md:hidden">
      ...
      {/* Drawer panel */}
      <div
        className={`fixed top-0 left-0 h-full w-[280px] bg-white z-50 flex flex-col shadow-xl transition-transform duration-250 ease-out ${
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-5 border-b border-border">
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 flex items-center justify-center rounded-full text-ink3 hover:bg-sand transition-colors"
        ...
        <div className="px-4 py-4 border-t border-border">
          ...
          <button
            ...
            className="w-full rounded-[10px] border border-border bg-sand px-3 py-[9px] text-[13px] font-medium text-ink2 text-left hover:bg-orange/5 hover:border-orange/30 transition-colors"
          >
            {t('signOut')}
          </button>
        </div>
